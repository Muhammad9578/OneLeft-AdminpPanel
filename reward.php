                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Rewards List</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" placeholder="Search....." class="form-control" name="search2" id="search2">
                                                    <span class="text-danger" id="msgtext2"></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <button onclick="searchingReward()" class="btn btn-info">Search</button>
                                                    <button onclick="loadListCallReward()" class="btn btn-secondary">Clear</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </thead>
